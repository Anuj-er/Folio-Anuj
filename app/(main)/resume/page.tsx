...
export default function ResumePage() {
    // Resume URL - can be local file or GitHub raw URL
    const resumeUrl = process.env.NEXT_PUBLIC_RESUME_URL || '/resume/resume.pdf';

    return (
        <div className="w-full bg-black min-h-screen pt-24 pb-12 px-4 sm:px-6 md:px-8">
            <div className="max-w-7xl mx-auto w-full flex flex-col items-center">

                {/* Minimal Header */}
                <div className="w-full flex items-center justify-between mb-6 max-w-[1000px]">
                ...
                {/* Increased height to ~1.4x (mobile) and 1.8x (desktop) viewport height to fit most 1-2 page resumes without scrolling */}
                <div className="w-full max-w-[1000px] h-[60vh] md:h-[140vh] overflow-hidden rounded-sm shadow-2xl relative bg-[#333]">
